...
<body>
  ...
  <div class="content">
    <div class="card">
      ...
      <h2>Player Health</h2>
      <p><select name="playerhealth" id="playerhealthid">
        <option value="210">Standard</option>
        <option value="211">One Shot Kills</option>
        <option value="212">Beast Mode</option>
        </select>
      </p>
      <h2>Game Time</h2>
      ...
      <p><select name="ambience" id="ambienceid">
        ...
        <option value="403">Stealth Indoor</option>
        <option value="404">Stealth Outdoor</option>
        </select>
      </p>
      ...
      <p><select name="presetgamemodes" id="presetgamemodesid">
        ...
        <option value="612">Contra</option>
        <option value="613">StarWars</option>
        <option value="614">Halo</option>
        </select>
      </p>
      <h2>Respawn Mode</h2>
...
if (!!window.EventSource) {
 ...
 source.addEventListener('new_readings', function(e) {
  ...
  function initButton() {
    ...
    document.getElementById('playerhealthid').addEventListener('change', handlehealth, false);
